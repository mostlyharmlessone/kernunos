...
The files for this program are in the directory \fmm on the CD-ROM and in the
archive file fmm.zip that may be downloaded from the PDAS web site.
...
additional information at the page  http://www.pdas.com/fmm.html
