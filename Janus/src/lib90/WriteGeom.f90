       ...
       integer :: i,j,M1,N1,vertices,faces,edges,unitno1,unitno2,unitno3
       integer(INT32) :: ivert1,ivert2,ivert3,ivert4
       logical :: donut,quad
...
!       0 0 255 #blue
       ...
       open(unitno2, file=trim(PLYBINNAME), access='stream', status='replace', &
          & action='write', iostat=io)
       unitno3 = get_new_fileunit()
       open(unitno3, file=trim(OFFNAME), action="write", iostat=ierr)

       if (ierr .ne. 0 .OR. io.ne.0) then
        write(*,*) 'File IO error in WriteGeom'
        stop
       endif
...
!       ASCII header for ASCII PLY
        write(unitno1,*) 'ply' 
        write(unitno1,*) 'format ascii 1.0'
        write(unitno1,*) 'comment Generated by Janus'
        write(unitno1,*) 'element vertex ',vertices         
        write(unitno1,*) 'property float32 x'        
        write(unitno1,*) 'property float32 y'       
        write(unitno1,*) 'property float32 z'      
        write(unitno1,*) 'element face ',faces     
        write(unitno1,*) 'property list uint8 int32 vertex_index' 
        write(unitno1,*) 'property uint8 red'
        write(unitno1,*) 'property uint8 green'
        write(unitno1,*) 'property uint8 blue'
        write(unitno1,*) 'end_header' 
!       ASCII header for binary PLY
        write(unitno2, iostat=io) 'ply' 
        write(unitno2, iostat=io) 'format binary_little_endian 1.0'
        write(unitno2, iostat=io) 'comment Generated by Janus'
        write(unitno2, iostat=io) 'element vertex ',vertices         
        write(unitno2, iostat=io) 'property float32 x'        
        write(unitno2, iostat=io) 'property float32 y'       
        write(unitno2, iostat=io) 'property float32 z'      
        write(unitno2, iostat=io) 'element face ',faces     
        write(unitno2, iostat=io) 'property list uint8 int32 vertex_index' 
        write(unitno2, iostat=io) 'property uint8 red'
        write(unitno2, iostat=io) 'property uint8 green'
        write(unitno2, iostat=io) 'property uint8 blue'
        write(unitno2, iostat=io) 'end_header'
...
!      Write vertices as REAL32                                                                   
       do i=1,M1
        do j=1,N1
         ...
         write(unitno2, iostat=io) vert1,vert2,vert3
...
!            attr=rgb2attr(rgbv)
            ...
            write(unitno2, iostat=io)'4',ivert1,ivert2,ivert3,ivert4,rgbv
            write(unitno3,*) '4',ivert1,ivert2,ivert3,ivert4,rgbv             
           else
            rgbv=rgb2(pow_face3_1,powmin,powmax)
!            attr=rgb2attr(rgbv)
            write(unitno1,*) '3',ivert1,ivert2,ivert3,rgbv
            write(unitno2, iostat=io)'3',ivert1,ivert2,ivert3,rgbv
            write(unitno3,*) '3',ivert1,ivert2,ivert3,rgbv
            rgbv=rgb2(pow_face3_2,powmin,powmax)
!            attr=rgb2attr(rgbv)
            write(unitno1,*) '3',ivert1,ivert2,ivert3,rgbv
            write(unitno2, iostat=io)'3',ivert1,ivert2,ivert3,rgbv                 
            write(unitno3,*) '3',ivert3,ivert4,ivert1,rgbv                                 
          endif
         else
!        nothing here yet                 
         endif
