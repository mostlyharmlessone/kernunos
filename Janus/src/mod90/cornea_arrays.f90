...
! MODULE PROCEDURE RadSlope_eq_Atlas
 ...
 MODULE PROCEDURE destroy_ZernJ
END INTERFACE
...
subroutine destroy_ZernJ(b,iflag) ! allocate Zernike array
  INTEGER, INTENT(IN) :: iflag
  TYPE(wpZernJ), INTENT(INOUT) :: b
  IF (iflag==0) THEN  
   deallocate (b%ZC)
  ENDIF
end subroutine destroy_ZernJ
