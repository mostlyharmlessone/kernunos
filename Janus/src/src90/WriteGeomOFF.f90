        ...
        if (donut .eqv. .FALSE.) then  ! inner set of faces
         do i=1,M1-1 ! j=1 and the origin j=0
          ...
          SELECT CASE (fct)
            ...
            CASE (17)
              pow_vert1=b%GAUSSC(1,i)
              pow_vert2=b%GAUSSC(1,i+1)
              pow_vert3=b%GAUSSC0(1)
            CASE (18)
            ...
            CASE (20)
              ...
              pow_vert3=b%Z0(1)
            CASE (21)
              pow_vert1=b%Warp(1,i)
              pow_vert2=b%Warp(1,i+1)
              pow_vert3=b%Warp0(1)
            CASE DEFAULT
              pow_vert1=b%SAGC(1,i)
              pow_vert2=b%SAGC(1,i+1)
...
!        Last face is different
         ...
         SELECT CASE (fct)
           ...
           CASE (16)
             ...
             pow_vert3=b%INSTC0(1)
           CASE (17)
             pow_vert1=b%GAUSSC(1,M1)
             pow_vert2=b%GAUSSC(1,1)
             pow_vert3=b%GAUSSC0(1)
           CASE (18)
           ...
           CASE (20)
             ...
             pow_vert3=b%Z0(1)
           CASE (21)
             pow_vert1=b%Warp(1,M1)
             pow_vert2=b%Warp(1,1)
             pow_vert3=b%Warp0(1)
           CASE DEFAULT
             pow_vert1=b%SAGC(1,M1)
             pow_vert2=b%SAGC(1,1)
...
!        rgbv=colormap(pow,powmin,powmax,map)
         ...
         SELECT CASE (fct)
           ...
           CASE (17)
             pow_vert1=b%GAUSSC(j+1,i)
             pow_vert2=b%GAUSSC(j+1,i+1)
             pow_vert3=b%GAUSSC(j,i)
             pow_vert4=b%GAUSSC(j,i+1)
           CASE (18)
           ...
           CASE (20)
             ...
             pow_vert4=b%Z(j,i+1)
           CASE (21)
             pow_vert1=b%Warp(j+1,i)
             pow_vert2=b%Warp(j+1,i+1)
             pow_vert3=b%Warp(j,i)
             pow_vert4=b%Warp(j,i+1)
           CASE DEFAULT
             pow_vert1=b%SAGC(j+1,i)
             pow_vert2=b%SAGC(j+1,i+1)
             pow_vert3=b%SAGC(j,i)
...
!        rgbv=colormap(pow,powmin,powmax,map)
         ...
         SELECT CASE (fct)
           ...
           CASE (17)
             pow_vert1=b%GAUSSC(j+1,M1)
             pow_vert2=b%GAUSSC(j+1,M1-1)
             pow_vert3=b%GAUSSC(j,M1)
             pow_vert4=b%GAUSSC(j,M1-1)
           CASE (18)
           ...
           CASE (21)
             pow_vert1=b%Warp(j+1,M1)
             pow_vert2=b%Warp(j+1,M1-1)
             pow_vert3=b%Warp(j,M1)
             pow_vert4=b%Warp(j,M1-1)
           CASE DEFAULT
             pow_vert1=b%SAGC(j+1,M1)
             pow_vert2=b%SAGC(j+1,M1-1)
             pow_vert3=b%SAGC(j,M1)
