* Source code of a number of Blas routines that are
* required by the Lapack linear equation solver used to
* illustrate the various different mechanisms available
* to package up routine libraries for inclusion in user
* programs.
