...
! Pick the required Blas routine up via the library specified in
! the Makefile.inc file -- if not available pick up the module from
! Chapter 3
!     USE BlasModule, ONLY : dnrm2
      IMPLICIT NONE
! Declaration only needed if using a library routine
      REAL(dkind) :: dnrm2
! Real constants
