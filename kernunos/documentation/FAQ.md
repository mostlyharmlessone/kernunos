...
```
.stl files: fstl apparently only reads binary stl files, (exported with the nonstandard abbreviation stlb) but without importing (admittedly nonstandard) color
```
